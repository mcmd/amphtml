...
/**
 * Localized string bundle used for es-419 strings.
...
const strings = {
  ...
  [LocalizedStringId.AMP_STORY_BOOKEND_PRIVACY_SETTINGS_BUTTON_LABEL]: {
    string: 'Cambiar la configuración de privacidad de los datos',
  },
  ...
  [LocalizedStringId.AMP_STORY_SHARING_CLIPBOARD_FAILURE_TEXT]: {
    string: 'No se pudo copiar el vínculo en el portapapeles :(',
  },
  [LocalizedStringId.AMP_STORY_SHARING_CLIPBOARD_SUCCESS_TEXT]: {
<<<<<<< HEAD
    string: '¡Enlace copiado!',
=======
    string: 'Se copió el vínculo.',
>>>>>>> upstream/master
  },
...
>>>>>>> upstream/master
  ...
  [LocalizedStringId.AMP_STORY_WARNING_UNSUPPORTED_BROWSER_TEXT]: {
    string: 'Parece que el navegador no es compatible con esta experiencia',
  },
};
